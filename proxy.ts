...
export async function proxy(request: NextRequest) {
  ...
  const publicPaths = ["/rider-login", "/register", "/scan", "/privacy", "/home", "/store", "/partner-register", "/systems", "/contact", "/liuming", "/llms.txt", "/og.png", "/480d2d55480284b1ce870c54bf62e21a.txt"];
