...
if [ $STATUS -eq 0 ]; then
  ...
  cp app/build/outputs/bundle/release/app-release.aab ../MePonto-v1.4.aab 2>>build-release.log \
    && echo "AAB copied to repo root: MePonto-v1.4.aab" >> build-release.log
else
