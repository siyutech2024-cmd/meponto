...
export default function ResetPasswordPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-8">
      <div className="industrial-shadow w-full max-w-lg rounded border border-[var(--line)] bg-[var(--surface)] p-5">
        <div className="mb-8 flex items-center gap-4">
          <BrandMark size="lg" />
          <div>
            <h1 className="text-3xl font-black">Reset Password</h1>
            <p className="text-sm uppercase text-[var(--muted)]">MePonto PontoSys account recovery</p>
          </div>
        </div>
        ...
        <form className="space-y-4" onSubmit={completeReset}>
          <label className="block">
            <span className="mb-2 block text-xs font-black uppercase text-[var(--muted)]">Verification Code</span>
            <span className="flex h-12 items-center gap-3 rounded border border-[var(--line)] bg-[var(--surface-raised)] px-3">
          ...
          <label className="block">
            <span className="mb-2 block text-xs font-black uppercase text-[var(--muted)]">New Password</span>
            <span className="flex h-12 items-center gap-3 rounded border border-[var(--line)] bg-[var(--surface-raised)] px-3">
        ...
        <Link href="/login" className="mt-5 block text-center text-sm font-bold text-[var(--muted)]">
          Back to Login
        </Link>
      </div>
    </main>
