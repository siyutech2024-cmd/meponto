...
export const portalConfigs: Record<PortalId, PortalConfig> = {
  pontosys: {
    ...
    modules: [
      ...
      { href: "/rider-monitor", label: "实时骑手看板", description: "Eastwind 实时在线骑手、状态分布、按加盟商/站点汇总;含当日累计数据页签。", permission: "manage_riders" },
  ...
  ponto: {
    ...
    modules: [
      ...
      { href: "/rider-monitor", label: "实时骑手看板", description: "本站点在线骑手实时状态;含当日累计数据页签。", permission: "manage_riders" },
...
export const testAccounts: TestAccount[] = [
  ...
  },
  {
    ...
    defaultPath: "/dispatch/franchise",
  },
  {
    id: "acct-ponto",
