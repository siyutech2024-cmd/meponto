...
export const portalConfigs: Record<PortalId, PortalConfig> = {
  ...
  franchise: {
    ...
    modules: [
      ...
      { href: "/rider-monitor", label: "实时骑手看板", description: "本加盟商在线骑手实时状态与状态分布。", permission: "manage_riders" },
  ...
  ponto: {
    ...
    modules: [
      ...
      { href: "/rider-monitor", label: "实时骑手看板", description: "本站点在线骑手实时状态。", permission: "manage_riders" },
