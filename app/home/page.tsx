...
/** Official social profiles (labels are proper nouns — identical in all languages). */
const SOCIALS: Array<{ label: string; href: string; icon: string }> = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/mepontooficial",
    // simple-icons style glyph paths (24x24)
...
const copy: Record<Lang, {
  ...
  pt: {
    ...
    footer: {
      tagline: "Um MePonto para cada motoboy",
      systems: [
  ...
  en: {
    ...
    footer: {
      tagline: "A MePonto for every motoboy",
      systems: [
